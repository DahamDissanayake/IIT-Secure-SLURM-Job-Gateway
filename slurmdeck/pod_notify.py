...
K pods are free"); a periodic checker (deploy/slurm-deck-pod-notify, run by a
...
def check_and_notify(stats=None) -> int:
    ...
    tests; the real checker script (deploy/slurm-deck-pod-notify) leaves it
