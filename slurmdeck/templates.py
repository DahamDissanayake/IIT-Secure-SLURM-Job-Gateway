...
from slurmdeck.config import Config, make_shared_writable, templates_dir
from slurmdeck.jobs import JobSpec
from slurmdeck.ui import STYLE, err, header, info, ok, warn
...
# sizing live from `slurmdeck.pods` (pod count from gres/shard via scontrol,
