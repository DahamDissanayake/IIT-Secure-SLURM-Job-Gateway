...
from slurmdeck.slurm import queue, cancel
...
def services_menu() -> None:
    import questionary
    from slurmdeck.ui import STYLE, info, ok, err, console, screen, select_menu
...
def launch_tensorboard() -> None:
    ...
    from slurmdeck.ui import STYLE, info, ok, err, kv, panel, screen
