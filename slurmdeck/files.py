...
def file_manager() -> None:
    ...
    import getpass
    import questionary
    from slurmdeck.config import load_config, user_dir, is_admin
    from slurmdeck.validate import in_user_browse_jail, in_user_upload_jail
    from slurmdeck.ui import STYLE, console, info, ok, err, screen, select_menu
