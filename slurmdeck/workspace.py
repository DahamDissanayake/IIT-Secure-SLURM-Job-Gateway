...
from slurmdeck.config import load_config, jobs_dir, models_dir
from slurmdeck.ui import BACK_TO_MAIN, console, info, screen, select_menu, warn
...
def run_workspace() -> None:
    ...
    while True:
        ...
        # ── Downloaded Models ─────────────────────────────────────────────────
        try:
            from slurmdeck.models import load_registry
        ...
        if choice is None:
            ...
            from slurmdeck.files import file_manager
            file_manager()
            ...
            from slurmdeck.setup import _run_env_setup, _run_install_prebuilt
            _run_env_setup(cfg)
            _run_install_prebuilt(cfg)
        elif choice == "Delete a model":
            from slurmdeck.models import _remove_interactive
