...
# Location of the optional site.env file. Override with SD_SITE_ENV.
_DEFAULT_SITE_ENV = "/opt/slurm-deck/deploy/site.env"
...
def _load_site_env() -> dict[str, str]:
    ...
    """
    path = os.environ.get("SD_SITE_ENV", _DEFAULT_SITE_ENV)
    data: dict[str, str] = {}
    try:
...
def load_config() -> Config:
    # Refresh site.env each call so tests that point SD_SITE_ENV elsewhere work.
    global _SITE
    _SITE = _load_site_env()
