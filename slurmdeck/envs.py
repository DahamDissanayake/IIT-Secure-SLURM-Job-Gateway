...
from slurmdeck.config import Config, models_dir, make_shared_writable
from slurmdeck.ui import err, header, info, ok, warn
...
def env_manager(cfg: Config) -> None:
    ...
    import questionary
    from slurmdeck.ui import header, info, ok, err
    from slurmdeck.containers import list_images, delete_image
